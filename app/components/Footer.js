        ...
        <footer className="bg-slate-900 text-white py-16">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="space-y-3 text-gray-300">
                            ...
                            <p className="font-medium text-white">ZEINAB LUNDIN</p>
                            <p>MAROUANN DOUMM</p>
                            <p className="flex items-center gap-2">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                <a href="mailto:marouanndoumm12@outlook.com" className="hover:text-green-300 transition-colors">
                            ...
                            <p className="flex items-center gap-2">
                                ...
                                <a href="tel:+19129231747" className="hover:text-green-300 transition-colors">
                                    +1 9129231747
                                </a>
                            </p>
                        </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-gray-300">
                            ...
                            <li>
                                <Link href="/listings" className="hover:text-green-300 transition-colors">
                                    Services
                                </Link>
                            </li>
                            <li>
                ...
                <div className="pt-8 border-t border-slate-800 text-center text-gray-400">
                    <p>&copy; {new Date().getFullYear()} Zeinab Lundin. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
